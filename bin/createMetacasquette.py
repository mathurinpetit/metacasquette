...
def createMetaCasquette(theme):
    ...
    promptDalle="L'image est une une casquette fabriquée en "+theme+" en couleur bien éclairé prise de face sur un fond blanc. La casquette lévite et il n'y a pas de sol et pas d'ombres autour. La casquette est vue de face avec la visière vers l'avant de l'image. Cette casquette a la forme d'une casquette de baseball classique avec une grande visière mais elle est fabriqué avec des "+theme+". La casquette est volumineuse et créée dans une matière unique : '"+theme+"'. Sa matière est entièrement du "+theme+" qui sont entiers. Il forment une casquette qui comprend environ entre 6 et 12 "+theme+". L'ensemble de ces "+theme+" sont de tailles et de volumes différents. La casquette est donc upcyclé ou recylclé. Attention la casquette n'a qu'une seule visière placée vers l'avant de l'image. "
    "Pour donner un exemple de ce genre de casquette, il peut s'agir d'une casquette fabriquée en carte à jouer, en morceaux d'ordinateur, en carte routière, en carte téléphonique ou bancaire, en paquet de gateaux ou de chips etc... D'ailleurs la taille des éléments de ces casquettes est a peu près celui d'une carte de crédit. La casquette est donc upcyclé ou recylclé. Elle est upcyclé uniquement en "+theme+" qui font la taille d'une carte de crédit. Attention la casquette est volumetrique mais elle n'est pas cubique. Elle reste arrondie avec une visière arrondie."
