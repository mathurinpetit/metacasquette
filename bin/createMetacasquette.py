...
def createMetaCasquette(theme):
    ...
    promptDalle="L'image est une une casquette fabriquée en "+theme+" en couleur bien éclairé prise de face sur un fond blanc. La casquette lévite et il n'y a pas de sol et pas d'ombres autour. La casquette est vue de face avec la visière vers l'avant de l'image. Cette casquette a la forme d'une casquette de baseball classique avec une grande visière mais elle est fabriqué avec des "+theme+". La casquette est volumineuse et créée dans une matière unique : '"+theme+"'. Sa matière est entièrement du "+theme+" qui sont entiers. Il forment une casquette qui comprend environ entre 10 et 20 "+theme+". L'ensemble de ces "+theme+" sont de tailles et de volume différent. La casquette est donc upcyclé ou recylclé. Attention la casquette n'a qu'une seule visière placée vers l'avant de l'image. "
